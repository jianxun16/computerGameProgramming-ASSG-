...
// Console cheat code. Click the console window, type the code (default "idkfa")
// and press Enter to toggle GOD MODE on/off. While it's on the player can't be
// killed (boss balls, spikes and the pit are ignored).
//
